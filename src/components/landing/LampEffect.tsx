...
export function LampEffect({ children, text }: LampEffectProps) {
  return (
    <LampContainer>
      <motion.h1
      ...
      <motion.div
        ...
        className="mt-1 bg-gradient-to-br from-slate-300 to-slate-500 bg-clip-text py-4 text-center font-medium tracking-tight text-transparent "
      >
        {children}
      </motion.div>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex min-h-[calc(100vh-64px)] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-950",
        className
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible bg-gradient-conic from-indigo-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
